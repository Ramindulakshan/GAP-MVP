                        ...
                        <CardGroup className="d-flex justify-content-center flex-wrap">
                            <Card className="m-5" style={{ backgroundColor: '#DCDDF9', width: '5rem' }}>
                                <Card.Body className="text-center">
                                    ...
                                    <Card.Title style={{ color: '#2A2A72', fontSize: '28px' }}>Mentors</Card.Title>
                                </Card.Body>

                            </Card>
                            <Card className="m-5" style={{ backgroundColor: '#DCDDF9', width: '10rem' }}>
                                <Card.Body className="text-center">
                                    <Card.Text>
                                        <h1>
                                            <CountUp start={0} end={892} duration={4} delay={0} />
                                    ...
                                    <Card.Title style={{ color: '#2A2A72', fontSize: '28px' }}>Members</Card.Title>
                                </Card.Body>
                            </Card>
                            <Card className="m-5" style={{ backgroundColor: '#DCDDF9', width: '10rem' }}>
                                <Card.Body className="text-center">
                                    ...
                                    <Card.Title style={{ color: '#2A2A72', fontSize: '28px' }}>Sessions</Card.Title>
                                </Card.Body>
                            </Card>
                        </CardGroup>
