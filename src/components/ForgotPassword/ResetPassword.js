                        ...
                        <div className='col-lg-6 overflow-auto '>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-9 sitewyey">
                                    ...
                                    <h5 className='mb-4 mt-2 ore'>You should enter at least 6 characters </h5>
                                    <div className="text-center">
                                        <button className="btn custom-button2rtyu  my-1 my-sm-3" type="submit" onClick={handleShow}>Reset</button>
                                    </div>
                                    <Modal size="medium" show={show} onHide={handleClose} aria-labelledby="contained-modal-title-vcenter" centered >
                                        <Modal.Body>
                                            <div className='text-center'>
                                                <img src={Password_image} alt='YourImage' className='img-fluid img-fluid custom-image-ULock2 mx-auto d-block mb-4' />
                                                <h2 className='mb-4'>Password Changed!</h2>
                                                <h4 className='mb-3 ore'>Your password has been changed successfully.</h4>
                                                <button className="btn  custom-button2rtyu my-1 my-sm-3" type="submit" >Login</button>
