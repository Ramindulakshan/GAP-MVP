                              ...
                              <div className="card-body d-md-flex">
                                <div className="text-section">
                                  ...
                                  <p className="card-para">
                                    Student at University of Colombo
                                    <br />
                                    <br />
                                    <button className="pbtnreqwet">
                                      Request Approved
                                    </button>
                                    <p className="para1">
                                ...
                                <p className="ptnpara ms-2 mb-0">
                                  <div className="card-body d-md-flex position-relative">
                                    <p className="pricep">LKRZ000.00</p>
                                  </div>
                                </p>
                              </div>
                            </div>
                              ...
                              <div className="card-body d-md-flex">
                                <div className="text-section">
                                  ...
                                  <p className="card-para">
                                    ...
                                    <br />
                                    <br />
                                    <button className="pbtnreqwetpen">
                                      Request Pending
                                    </button>
                                    <p className="para1">
                                      Expectation of this mentoring session
                              ...
                              <div className="card-body d-md-flex">
                                <div className="text-section">
                                  ...
                                  <p className="card-para">
                                    ...
                                    <br />
                                    <br />
                                    <button className="pbtnreqwetdes">
                                      Request Declined{" "}
                                    </button>
                                    <p className="para1">
                                      Expectation of this mentoring session
                          ...
                          <div className="card">
                            <div className="d-md-flex">
                              ...
                              <div className="card-body d-md-flex">
                                ...
                                <div className="container mt-4 btnsetbx">
                                  <div className="row justify-content-center ">
                                    <div className="col-auto ">
                                      <button className="cancel2ac">
                                        Accept
                                      </button>
                                      &nbsp;&nbsp;
                                      <button className="cancel2  mr-2">
                                        Decline
                                      </button>
                                    </div>
                                  </div>
                                    ...
                                    <div className="text-section">
                                      ...
                                      <p className="card-para">
                                        ...
                                        <p className="para2">
                                          ...
                                          condimentum eu arcu vel tempus. Ut
                                          faucibus id velit vel porttitor. Duis
                                          eu porttitor sem. el tempus. Ut
                                          faucibus id velit vel porttitor. Duis
                                          eu porttitor sem.el tempus. Ut
                                          faucibus id velit vel{" "}
                                        </p>
                                        <p className="para3">
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
